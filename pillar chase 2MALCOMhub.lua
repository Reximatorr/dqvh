...
local function createUI()
    MenuState.screenGui = Instance.new("ScreenGui")
    MenuState.screenGui.Name = "AdvancedMobileMenu"
    MenuState.screenGui.ResetOnSpawn = false
    MenuState.screenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    MenuState.screenGui.Parent = PlayerGui
    
    MenuState.menuFrame = Instance.new("Frame")
    MenuState.menuFrame.Name = "MenuFrame"
    MenuState.menuFrame.Size = UDim2.new(0, 130, 0, 190)
    MenuState.menuFrame.Position = UDim2.new(0, 10, 0, 10)
    MenuState.menuFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    MenuState.menuFrame.BorderSizePixel = 1
    MenuState.menuFrame.BorderColor3 = Color3.fromRGB(100, 100, 100)
    MenuState.menuFrame.Visible = true
    MenuState.menuFrame.Parent = MenuState.screenGui
    ...
    HeaderFrame.Parent = MenuState.menuFrame
    ...
    MenuState.iconFrame = Instance.new("Frame")
    MenuState.iconFrame.Name = "IconFrame"
    MenuState.iconFrame.Size = UDim2.new(0, 40, 0, 40)
    MenuState.iconFrame.Position = UDim2.new(0, 10, 0, 10)
    MenuState.iconFrame.BackgroundColor3 = Color3.fromRGB(50, 150, 200)
    MenuState.iconFrame.BorderSizePixel = 1
    MenuState.iconFrame.BorderColor3 = Color3.fromRGB(100, 200, 255)
    MenuState.iconFrame.Visible = false
    MenuState.iconFrame.Parent = MenuState.screenGui
    
    local UICorner = Instance.new("UICorner")
    UICorner.CornerRadius = UDim.new(0, 8)
    UICorner.Parent = MenuState.iconFrame
    ...
    IconText.Parent = MenuState.iconFrame
    
    local buttons = {
        {Name = "Enable ESP", Func = function() v15(true) end},
        {Name = "INF Monster Stamina", Func = v10},
        {Name = "FullBright", Func = v11},
        {Name = "Infinite Yield", Func = v13},
    }
    ...
    buttonContainer.Parent = MenuState.menuFrame
    
    for i, btn in ipairs(buttons) do
        local Button = Instance.new("TextButton")
        Button.Name = btn.Name
        Button.Size = UDim2.new(1, -4, 0, 35)
        Button.Position = UDim2.new(0, 2, 0, (i-1) * 36)
    ...
    setupDragging(MenuState.menuFrame)
    setupDragging(MenuState.iconFrame)
    
    MinimizeBtn.MouseButton1Click:Connect(function()
        MenuState.isMinimized = true
        MenuState.menuFrame.Visible = false
        MenuState.iconFrame.Visible = true
    end)
    
    MenuState.iconFrame.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
    ...
    MenuState.iconFrame.MouseEnter:Connect(function()
        MenuState.iconFrame.BackgroundColor3 = Color3.fromRGB(80, 180, 230)
    end)
    MenuState.iconFrame.MouseLeave:Connect(function()
        MenuState.iconFrame.BackgroundColor3 = Color3.fromRGB(50, 150, 200)
    end)
end
...
print("✓ Mobile menu loaded! Click − to minimize, click M to expand")
-- ===== END MOBILE MENU =====
